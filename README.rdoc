...
agregar botoon volver a Stock simple y complejo
...
1) como itero y me quedo con los precios_netos que no son nil para que cuando todos esten hechos, pueda mostrar el boton CERRAR VENTA en movements.html.erb?

2) proceso en background para guardar en la BD el valor dolar de la api
